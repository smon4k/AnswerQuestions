    ...
    <div class="nav-container">
        <div class="container">
            <div class="headerNav-container">
                <div class="sider-inner">
                    ...
                    <div class="logo">
                        <router-link to="/" class="logo-link">
                            <i class="el-icon-arrow-left" v-if="$route.path === '/score'"></i>
                            <!-- <img
                                src="@/assets/log.jpeg"
                                alt=""
                ...
                <div class="language" v-if="$route.path !== '/answer'">
                      <el-button type="text" v-if="language === 'en'" @click="clickLanguageDropdown('zh')">中文</el-button>
                      <el-button type="text" v-else @click="clickLanguageDropdown('en')">英文</el-button>
